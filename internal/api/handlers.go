...
import (
	...
	"yanita_inventario/internal/api/dtos"
...
func (a *API) UserRegister(c echo.Context) error {
...
func (a *API) ProductRegister(c echo.Context) error {
	...
	err = a.serv.ProductRegister(ctx, p, email)
	if err != nil {
		log.Println(err)
