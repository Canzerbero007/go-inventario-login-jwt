...
// ProductRegister provides a mock function with given fields: ctx, name, description, price, createdBy
func (_m *MockRepository) ProductRegister(ctx context.Context, name string, description string, price float32, createdBy int64) error {
...
// UserFindByEmail provides a mock function with given fields: ctx, email
func (_m *MockRepository) UserFindByEmail(ctx context.Context, email string) (*entity.User, error) {
...
// UserRegister provides a mock function with given fields: ctx, email, name, password
func (_m *MockRepository) UserRegister(ctx context.Context, email string, name string, password string) error {
