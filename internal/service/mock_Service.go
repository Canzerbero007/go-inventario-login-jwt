...
// ProductRegister provides a mock function with given fields: ctx, product, userEmail
func (_m *MockService) ProductRegister(ctx context.Context, product models.Product, userEmail string) error {
